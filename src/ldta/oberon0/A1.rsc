...
public set[Message] bindL1(loc l) = errs
   when <_, errs> := ldta::oberon0::l1::Bind::bindModule(
     ldta::oberon0::l1::Implode::implode(parseL1(l)), scope(()));

public set[Message] bindL2(loc l) = errs
   when <_, errs> := ldta::oberon0::l2::Bind::bindModule(
     ldta::oberon0::l2::Implode::implode(parseL2(l)), scope(()));
