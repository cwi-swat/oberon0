module lang::oberon0::desugar::Desugar
...
data Statement 
	...
	| withDo(Expression record, list[Statement] body)
	;
...
public Module desugar(Module mod) {
	return visit (mod) {
		case Procedure p => (for2letWhile o repeat2while o let2begin o flattenBegin)(p)
	}
}


public Procedure with2begin(Procedure p) {
	// todo: need type information; wait for Mark
}
