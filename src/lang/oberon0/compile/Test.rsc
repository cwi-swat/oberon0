...
public lang::oberon0::ast::Oberon0::Module parseQuickSort() {
  return delAnnotationsRec(
    implode(#lang::oberon0::ast::Oberon0::Module,
    parse(#lang::oberon0::syntax::Oberon0::Module, |project://oberon0/src/quicksort.oberon0|)));
}

public lang::oberon0::ast::Oberon0::Module parseTest() {
  return parseSomething( |project://oberon0/src/test.oberon0| );
}

public lang::oberon0::ast::Oberon0::Module parseSample() {
  return parseSomething( |project://oberon0/src/sample.oberon0| );
}

public lang::oberon0::ast::Oberon0::Module parseSomething(loc location) {
  return delAnnotationsRec(
    implode(#lang::oberon0::ast::Oberon0::Module,
    parse(#lang::oberon0::syntax::Oberon0::Module, location)));
}
